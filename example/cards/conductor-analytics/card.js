...
define("templates",
  ...
  function() {
    ...
    helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
      ...
      hashTypes = {};
      hashContexts = {};
      data.buffer.push(escapeExpression(helpers.action.call(depth0, "switchRoutes", {hash:{},contexts:[depth0],types:["STRING"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
