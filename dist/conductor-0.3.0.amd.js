define("conductor",
  ["conductor/services","oasis","conductor/version","conductor/card_reference","conductor/card_dependencies","oasis/shims","conductor/shims","conductor/multiplex_service","conductor/adapters"],
  function(__dependency1__, Oasis, Version, CardReference, CardDependencies, OasisShims, ConductorShims, MultiplexService, adapters) {
    "use strict";
    var services = __dependency1__.services;
    var capabilities = __dependency1__.capabilities;
...
define("conductor/adapters",
  ["oasis/iframe_adapter","conductor/inline_adapter"],
  function(iframeAdapter, inlineAdapter) {
    "use strict";
...
define("conductor/inline_adapter",
  ["oasis/shims","oasis/inline_adapter"],
